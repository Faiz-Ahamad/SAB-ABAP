...
*&
*&---------------------------------------------------------------------*
REPORT y_sub_display_select_option.
...
PERFORM get_hdr_2 USING s_ino[] CHANGING it_data.


IF it_data IS NOT INITIAL.
  PERFORM get_itm(Y_SUB_DISPLAY) USING it_data CHANGING it_data1 IF FOUND.
ENDIF.

PERFORM data_dis IN PROGRAM Y_SUB_DISPLAY USING it_data it_data1 CHANGING it_final IF FOUND.
